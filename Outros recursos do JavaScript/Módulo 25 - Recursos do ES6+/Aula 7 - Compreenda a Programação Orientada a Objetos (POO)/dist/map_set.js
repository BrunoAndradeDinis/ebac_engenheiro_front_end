...
try {
  for (_iterator4.s(); !(_step4 = _iterator4.n()).done;) {
    var _step4$value = _slicedToArray(_step4.value, 2),
      _chave3 = _step4$value[0],
      valor = _step4$value[1];
    console.log("".concat(_chave3, ": ").concat(valor));
  }
} catch (err) {
  _iterator4.e(err);
} finally {
...
var arrayTeste = ["BRuno de", "Hola patron", "Joao fulano", "Bruno", "Bruno", "BRuno de", "Ana", "julia", "Ana"];
console.log(arrayTeste);
var arrayComoSet = new Set([].concat(arrayTeste));
