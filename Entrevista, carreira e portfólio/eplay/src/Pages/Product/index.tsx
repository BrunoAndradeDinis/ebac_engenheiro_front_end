...
const Product = () => {
  ...
  return (
    <>
      <Hero />
      <Section title={`Sobre o jogo`} backgroundColor="black">
        <p>
      ...
      <Section title={`Mais detalhes`} backgroundColor="gray">
        <p>
          <b> Plataforma:</b> PlayStation 5
          <br /> <b>Desenvolvedor:</b> Avalanche Software
          <br />
      ...
      <Gallery defaultCover={logo} name="Hogwarts Legacy" />
    </>
  )
}
