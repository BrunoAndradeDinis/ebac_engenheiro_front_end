    ...
    <form className={form}>
      <div className={form__container}>
        ...
        <div className={form__container__item}>
          ...
          <input type="number" id="altura"  step="0.01" placeholder="1.75" max={2.2} min={.1} onBlur={({target}) => parseFloat(setAltura(target.value))}/>
        </div>
        <div className={form__container__item}>
          <label htmlFor="peso">Peso:</label>
          <input type="number" id="peso"  step="0.01" placeholder="74.50" max={200.2} min={.1} onBlur={({target}) => parseFloat(setPeso(target.value))}/>
        </div>
